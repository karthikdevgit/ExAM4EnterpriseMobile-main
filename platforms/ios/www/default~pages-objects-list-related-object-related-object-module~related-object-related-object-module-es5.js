(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-objects-list-related-object-related-object-module~related-object-related-object-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesObjectsListRelatedObjectRelatedObjectPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesObjectsListRelatedObjectRelatedObjectRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RelatedObjectPageRoutingModule", function () {
        return RelatedObjectPageRoutingModule;
      });
      /* harmony import */
      ...
      var _related_object_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./related-object.page */
      ...
      var RelatedObjectPageRoutingModule = function RelatedObjectPageRoutingModule() {
        _classCallCheck(this, RelatedObjectPageRoutingModule);
      };

      RelatedObjectPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesObjectsListRelatedObjectRelatedObjectModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RelatedObjectPageModule", function () {
        return RelatedObjectPageModule;
      });
      /* harmony import */
      ...
      var _related_object_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./related-object-routing.module */
      "./src/app/pages/objects-list/related-object/related-object-routing.module.ts");
      /* harmony import */


      var _related_object_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./related-object.page */
      "./src/app/pages/objects-list/related-object/related-object.page.ts");
      /* harmony import */
      ...
      var src_app_svcomponents_each_amrender_each_amrender_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/svcomponents/each-amrender/each-amrender.component */
      "./src/app/svcomponents/each-amrender/each-amrender.component.ts");

      var RelatedObjectPageModule = function RelatedObjectPageModule() {
        _classCallCheck(this, RelatedObjectPageModule);
      };

      RelatedObjectPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _related_object_routing_module__WEBPACK_IMPORTED_MODULE_5__["RelatedObjectPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesObjectsListRelatedObjectRelatedObjectPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesObjectsListRelatedObjectRelatedObjectPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RelatedObjectPage", function () {
        return RelatedObjectPage;
      });
      /* harmony import */
      ...
      var RelatedObjectPage = /*#__PURE__*/function () {
        function RelatedObjectPage(router, route, GlobalParamService) {
          _classCallCheck(this, RelatedObjectPage);
          ...
          console.log("related object list page call"); // _this.schemaViewData = _this.router.getCurrentNavigation().extras.state.schemaViewData;
          // _this.relatedIndex = _this.router.getCurrentNavigation().extras.state.relatedIndex;
          // _this.parentId = _this.router.getCurrentNavigation().extras.state.parentId;
        }

        _createClass(RelatedObjectPage, [{
          key: "ngOnInit",
          ...
          value: function previousRleatedScreen() {
            ...
            if (_this.GlobalParamService.trackparamFormObjRedirect && _this.GlobalParamService.trackparamFormObjRedirect.length > 0) {
              console.log('_this.GlobalParamService.trackparamFormObjRedirect.length', _this.GlobalParamService.trackparamFormObjRedirect.length); //Added for  last level render 2 time issue fix
              ...
              if (parentnavigationExtras && parentnavigationExtras.state) {
                ...
                console.log('navigationExtras', parentnavigationExtras); // if( parentnavigationExtras.isFrom=='objectButtoncall'){
                // console.log('parentnavigationExtras.isFrom',parentnavigationExtras.isFrom);

                _this.router.navigate(['/redirectpageforrelatedlevel-obj'], parentnavigationExtras); //  }else if( parentnavigationExtras.isFrom=='allRelatedcall'){
                //   console.log('parentnavigationExtras.isFrom',parentnavigationExtras.isFrom);
      ...
      RelatedObjectPage.ctorParameters = function () {
        return [{
      ...
      RelatedObjectPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-related-object",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./related-object.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/objects-list/related-object/related-object.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./related-object.page.scss */
        "./src/app/pages/objects-list/related-object/related-object.page.scss"))["default"]]
      })], RelatedObjectPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~pages-objects-list-related-object-related-object-module~related-object-related-object-module-es5.js.map