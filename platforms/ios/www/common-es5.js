(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesObjectsListAllRelatedRecordRenderAllRelatedRecordRenderPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppSvcomponentsEachAmrenderEachAmrenderComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesObjectsListAllRelatedRecordRenderAllRelatedRecordRenderRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllRelatedRecordRenderPageRoutingModule", function () {
        return AllRelatedRecordRenderPageRoutingModule;
      });
      /* harmony import */
      ...
      var _all_related_record_render_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./all-related-record-render.page */
      ...
      var AllRelatedRecordRenderPageRoutingModule = function AllRelatedRecordRenderPageRoutingModule() {
        _classCallCheck(this, AllRelatedRecordRenderPageRoutingModule);
      };

      AllRelatedRecordRenderPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesObjectsListAllRelatedRecordRenderAllRelatedRecordRenderModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllRelatedRecordRenderPageModule", function () {
        return AllRelatedRecordRenderPageModule;
      });
      /* harmony import */
      ...
      var _all_related_record_render_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./all-related-record-render-routing.module */
      "./src/app/pages/objects-list/all-related-record-render/all-related-record-render-routing.module.ts");
      /* harmony import */


      var _all_related_record_render_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./all-related-record-render.page */
      "./src/app/pages/objects-list/all-related-record-render/all-related-record-render.page.ts");
      /* harmony import */


      var src_app_svcomponents_each_object_render_each_object_render_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var src_app_svcomponents_each_related_obj_button_render_each_related_obj_button_render_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var src_app_svcomponents_each_ambutton_render_each_ambutton_render_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var src_app_svcomponents_tree_view_enabled_tree_view_enabled_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var src_app_svcomponents_tree_view_not_enabled_tree_view_not_enabled_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var AllRelatedRecordRenderPageModule = function AllRelatedRecordRenderPageModule() {
        _classCallCheck(this, AllRelatedRecordRenderPageModule);
      };

      AllRelatedRecordRenderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _all_related_record_render_routing_module__WEBPACK_IMPORTED_MODULE_5__["AllRelatedRecordRenderPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesObjectsListAllRelatedRecordRenderAllRelatedRecordRenderPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesObjectsListAllRelatedRecordRenderAllRelatedRecordRenderPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllRelatedRecordRenderPage", function () {
        return AllRelatedRecordRenderPage;
      });
      /* harmony import */
      ...
      var AllRelatedRecordRenderPage = /*#__PURE__*/function () {
        function AllRelatedRecordRenderPage(router, route, GlobalParamService) {
          _classCallCheck(this, AllRelatedRecordRenderPage);
          ...
          this.route.queryParams.subscribe(function (params) {
            _this.schemaViewData = _this.router.getCurrentNavigation().extras.state.schemaViewData; //if it call from all related record page not pass related inde it pass only current index so here assign relted inex value ti currentIndex

            _this.currentIndex = _this.router.getCurrentNavigation().extras.state.relatedIndex;
        ...
        _createClass(AllRelatedRecordRenderPage, [{
          key: "ngOnInit",
          ...
          value: function previousRleatedScreen() {
            ...
            if (_this.GlobalParamService.trackparamFormObjRedirect && _this.GlobalParamService.trackparamFormObjRedirect.length > 0) {
              console.log('_this.allrelated.trackparamFormObjRedirect.length', _this.GlobalParamService.trackparamFormObjRedirect.length); //Added for  last level render 2 time issue fix

              var navigationExtras = _this.GlobalParamService.trackparamFormObjRedirect[_this.GlobalParamService.trackparamFormObjRedirect.length - 1];
              ...
              if (_this.currentIndex == navigationExtras.state.currentIndex) {
                var currentlevelIndex = _this.GlobalParamService.trackparamFormObjRedirect.length - 1;
              ...
              var lastIndex = _this.GlobalParamService.trackparamFormObjRedirect.length - 1;
              console.log('lastIndex-1', lastIndex);
              console.log('allrelated', _this.GlobalParamService.trackparamFormObjRedirect, lastIndex);
              var parentnavigationExtras = _this.GlobalParamService.trackparamFormObjRedirect[lastIndex];
              ...
              if (parentnavigationExtras && parentnavigationExtras.state) {
                ...
                parentnavigationExtras.state.isFromback = true; //  _this.GlobalParamService.trackparamFormObjRedirect.splice(lastIndex, 1); // Removes the last element
      ...
      AllRelatedRecordRenderPage.ctorParameters = function () {
        return [{
      ...
      AllRelatedRecordRenderPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-all-related-record-render',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./all-related-record-render.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/objects-list/all-related-record-render/all-related-record-render.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./all-related-record-render.page.scss */
        "./src/app/pages/objects-list/all-related-record-render/all-related-record-render.page.scss"))["default"]]
    ...
    /***/
    function srcAppSvcomponentsEachAmrenderEachAmrenderComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppSvcomponentsEachAmrenderEachAmrenderComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EachAMRenderComponent", function () {
        return EachAMRenderComponent;
      });
      /* harmony import */
      ...
      var EachAMRenderComponent = /*#__PURE__*/function () {
        function EachAMRenderComponent(router) {
          _classCallCheck(this, EachAMRenderComponent);
        ...
        _createClass(EachAMRenderComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;
      ...
      EachAMRenderComponent.ctorParameters = function () {
        return [{
          type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
        }];
      };
      ...
      EachAMRenderComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-each-amrender',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./each-amrender.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/svcomponents/each-amrender/each-amrender.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./each-amrender.component.scss */
        "./src/app/svcomponents/each-amrender/each-amrender.component.scss"))["default"]]
